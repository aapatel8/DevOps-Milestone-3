...
function callGetDropletInfo() {
	client.getDropletInfo(dropletId, function(error, response) {
		...
		// Save stable server ip to use in infruastructure.js of loadbalancer
		var ip_logger = fs.createWriteStream('stable', {
